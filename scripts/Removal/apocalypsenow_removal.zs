...
recipes.remove(<item:apocalypsenow:mcu2p_gasmask_chestplate>);
...
recipes.remove(<item:apocalypsenow:deerhornknife>);
...
JEI.hideIngredient(<item:apocalypsenow:energy_drink>);
...
JEI.hideIngredient(<item:apocalypsenow:deerhornknife>);
